...
<nav className="bg-black top-0 fixed w-screen z-20 text-2xl text-center">
  ...
  <Link to="/" className="flex items-center">
      <img src={logo} className="h-10 rounded-2xl ml-10" alt="cafe logo"></img>
  </Link>
  <div className="flex justify-between items-center p-5 mb-2 gap-20 text-white text-2xl sm:text-2xl ">
              ...
              <li className='hover:scale-105   hover:text-blue-600'>
                ...
                <Link to="/reservation" >
              <button type="button" className="font-medium text-orange-400 rounded-lg text-center hover:scale-105   hover:text-blue-600">Reservation</button>  
              </Link>
              </ul> 
            </div>
            </div>
